...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'content-manager'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Episodes', path: '/episodes', entity: 'episode', service: AccessServiceEnum.PROJECT, icon: FiPlayCircle },
    { name: 'Movies', path: '/movies', entity: 'movie', service: AccessServiceEnum.PROJECT, icon: FiFilm },
    { name: 'Seasons', path: '/seasons', entity: 'season', service: AccessServiceEnum.PROJECT, icon: FiCalendar },
