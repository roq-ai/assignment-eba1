...
import { getSeasonById } from 'apiSdk/seasons';
import { SeasonInterface } from 'interfaces/season';
import { EpisodeListPage } from 'pages/episodes';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('season', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/seasons/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Season Number" text={data?.season_number} />
