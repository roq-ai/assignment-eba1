...
import { getEpisodeById } from 'apiSdk/episodes';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('episode', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/episodes/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                <FormListItem label="Episode Number" text={data?.episode_number} />
                ...
                {hasAccess('season', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                  <FormListItem
                    label="Season"
                    text={
                      <Link as={NextLink} href={`/seasons/view/${data?.season?.id}`}>
